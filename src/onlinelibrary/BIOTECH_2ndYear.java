...
import java.util.*;
import java.sql.*;
public class BIOTECH_2ndYear extends Frame implements ActionListener,ItemListener
{
	...
	String s="",s1[]={"Home","Borrow","UG","BIOTECH 2nd Year"}
	,s2[]={"Calculus for Biotechnology","Process Engineering Principles","Biochemistry","Cell biology","Microbiology","Genetics","Computational numerical methods","Chemical and Biochemical Thermodynamics","Molecular Biology","Immunology","Instrumental Methods in Biotechnology","Industrial Biotechnology"};
	String 
	s3[]={"KantiB.Datta","Hougen and Watson","David Lee Nelson and Michael M","Geoffrey M. Cooper","Michael T. Madigan","singh","KantiB.Datta","J.M.Smith","David Freifelder","Judith A. Owen","Keith Wilson","Crueger W and Crueger A"},
	s4[]={"B.S.Grewal","Bhatt B I and S M Vora","Donald Voet and Judith G. Voet","Gerald Karp","Joanne M. Willey","Snustad","Mittal","Y.V.C.Rao","Harvey F. Lodish","Peter J. Delves","Sivasankar","Casida L. E"};
	...
	BIOTECH_2ndYear()
	{
		...
		setSize(1500,1500);
		setLayout(null);
		setTitle("BIOTECH 2nd Year");
		

		l1=new Label("BIOTECH 2nd Year");
