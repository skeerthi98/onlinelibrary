...
import java.io.*;
import java.sql.*;
public class Biotech_1stYear extends Frame implements ActionListener,ItemListener
{
	...
	String s="",s1[]={"Home","Borrow","UG","Biotech_1stYear"}
	,s2[]={"English - I","Mathematics - I","Engineering Physics - I","General Chemistry","Programming and Problem Solving","Fundamentals of Biotechnology","Principles of Electrical Engineering","English - II","Mathematics - II","Biophysics","Bio-organic Chemistry","Object Oriented Programming through C++","Environmental Studies","Introduction to Anatomy and Physiology of Humans"};
	String 
	s3[]={"E Suresh Kumar","Kanti.B.Datta","M.N. Avadhanulu","Morison & Boyd","PradipDey and ManasGhosh","C.B. Powar","Edward Hughes","E Suresh Kumar","N. Krishnamurthy","RB Setlow","Robert. T. Morrison","E. Balagurusamy","Y. Anjaneyulu","Charles E. Tobin"},
	s4[]={"Michael McCarthy","Michael Greenburg","S.L. Gupta","Finar","R S Bichkar","P.K. Gupta","V.K. Mehta","Michael McCarthy","S. Chand series","A.G.Marshall","JL.jain","Bjarne Stroustrup","S.S.Dara","J. H. Green"};
	...
	Biotech_1stYear() 
	{
		...
		setSize(1500,1500);
		setLayout(null);
		setTitle("Biotech 1st Year");
		
		
		
		l1=new Label("Biotech 1st Year");
	...
	public void paint(Graphics g)
	{
		...
		g.drawRect(600,250,500,200);
		g.drawString("AUTHORS",770,270);
