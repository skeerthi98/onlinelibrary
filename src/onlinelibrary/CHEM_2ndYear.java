...
import java.util.*;
import java.sql.*;
public class CHEM_2ndYear extends Frame implements ActionListener,ItemListener
{
	...
	String s="",s1[]={"Home","Borrow","UG","CHEM 2nd YEAR"}
	,s2[]={"Fourier Analysis and Partial Differential Equations","Chemical Technology","Material and Energy Balances","Physical Chemistry","Basics of Mechanical and Electrical Engineering","Complex Variables and Probability Statistics","Fluid Mechanics","Chemical Engineering Thermodynamics-I","Mechanical Unit Operations","Chemical Reaction Engineering-I"};
	String 
	s3[]={"Kanti.B.Datta","Dryden","Bhatt and Thakone","GM Barrow","S Ramamrutham","Kanti B Dutta","Cabe and Smith","Y V C Rao","Cabe and Smith","Octave Levenspeil"},
	s4[]={"BS Grewal","Shreve","Hyuegen and Watson","KL Kapoor","VK Mehta","BS Grewal","James O Wilkis","JC Smith","Coulson and Richard","JM Smith"};
	...
	CHEM_2ndYear()
	{
		...
		setSize(1500,1500);
		setLayout(null);
		setTitle("CHEM 2nd YEAR");
		

		l1=new Label("CHEM 2nd YEAR");
