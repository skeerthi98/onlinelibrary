...
import java.util.*;
import java.sql.*;
public class CHEM_3rdYear extends Frame implements ActionListener,ItemListener
{
	...
	String s="",s1[]={"Home","Borrow","UG","CHEM 3rd YEAR"}
	,s2[]={"Chemical Reaction Engineering-II","Mass Transfer Operations - I","Process Dynamics and Control","Process Heat Transfer","Process Instrumentation","Human Values and Professional Ethics","Biochemical Engineering","Chemical Engineering Thermodynamics - II","Energy Engineering","Process Modelling Simulation and Optimisation","Surface Coating Technology","Technology of Vegetable Oils and Fats"};
	String 
	s3[]={"Octave Levenspeil","RE Treybal","Donald R Coughanowr","Cabe and Smith","Donald P Eckman","Subramanian R","Bailey and Ollis","Smith and VanNess","GD Rai","William L Luyben","WM Morgan","Ed D Swern"},
	s4[]={"JM Smith","Coulson and Richardson","Peter Harriott","JP Hollman","Patranabis D ","Nagarajan RS","Shuler and FikretKargi","YVC Rao","Samir Sarkar","SS Rao","Patton Temple","OP Narula "};
