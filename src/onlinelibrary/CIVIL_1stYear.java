...
import java.util.*;
import java.sql.*;
public class CIVIL_1stYear extends Frame implements ActionListener,ItemListener
{
	...
	String s="",s1[]={"Home","Borrow","UG","CIVIL 1st YEAR"}
	,s2[]={"English - I","Mathematics - I","Engineering Physics - I","Engineering Chemistry - I","Structured Programming","Engineering Mechanics - I","Engineering Graphics-I","English - II","Mathematics - II","Engineering physics-II","Engineering Chemistry - II","Object Oriented Programming through C++","Engineering Mechanics - II","Engineering Graphics-II"};
	String 
	s3[]={"E Suresh Kumar","Kanti.B.Datta","M.N. Avadhanulu","P.C.Jain and Monica Jain","PradipDey and ManasGhosh","K. Vijay Kumar Reddy","N.D Bhatt","E Suresh Kumar","BS. Grewal","M.N. Avadhanulu","Jain and Jain","E. Balagurusamy","K.Vijay Kumar and N.suresh","N.D.Bhatt"},
	s4[]={"Michael McCarthy","Michael Greenburg","S.L. Gupta","Puri & Sharma","R S Bichkar","Ferdinand L Singer","Basanth Agrawal and C M Agrawal ","– K.R. Lakshminarayan ","Michael Greenburg, ","S.L. Gupta","Puri & Sharma","Bjarne Stroustrup ","Ferdinand L Singer","Basanth Agrawal"};
