...
import java.util.*;
import java.sql.*;
public class CIVIL_2ndYear extends Frame implements ActionListener,ItemListener
{
	...
	String s="",s1[]={"Home","Borrow","UG","CIVIL 2nd YEAR"}
	,s2[]={"Fourier Analysis and Partial Differential Equations","Building Drawing","Engineering Materials&Construction ","Engineering Geology","Strength of Materials - I ","Surveying - I","Strength of materials-II","Surveying-II","Fluid mechanics-I","Environmental studies","Electrical Technology and material technology","Managerial Economics and accountancy"};
	String 
	s3[]={"Kanti b Datta","S.P Aurora","Parbin Singh","B.C Punmia","C.venkata ramaiah","B.C punmia","C.Venkataramaiah","P.N Modi","Y.Anjaneylu","V.K mehta","Mahesh Varma","Mehta PL"},
	s4[]={"B.S.Grewal","Sushil kumar","Chenna Kesavulu.N","S.Ramamrutham","S.K. Duggal","S.Ramamrutham","B.C. Punmia","A.K.Jain"," Dr. Suresh K. Dhameja"," H. Cotton","R.LPeurifoy"," Maheswari S.N" };
