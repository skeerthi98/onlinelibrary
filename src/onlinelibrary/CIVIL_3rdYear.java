...
import java.util.*;
import java.sql.*;
public class CIVIL_3rdYear extends Frame implements ActionListener,ItemListener
{
	...
	String s="",s1[]={"Home","Borrow","UG","CIVIL 3rd YEAR"}
	,s2[]={"Reinforced Concrete Design-I","Fluid Mechanics - II","Theory of Structures-I","Building Planning and Services","Transportation Engineering","Water & Waste Water Engg.","Soil Mechanics","Design of Steel Structures","Theory of Structures-II","Reinforced Concrete Design","Water Resources Engineering-I","Elective - I"};
	String 
	s3[]={"N.Subramanian","K. Subramanya","T.S.Thandavamoorthy","V.S. Shahane.","Khanna. S. K.","G.S. Birdi,","C.Venkataramaiah","P.N Modi","Y.Anjaneylu","V.K mehta","Mahesh Varma","Mehta PL"},
	s4[]={"Unni Krishnan","Victor L. Streeter","Ramamrutham.S","Michael Bauer","McShane","Garg, S.K.","B.C. Punmia","A.K.Jain"," Dr. Suresh K. Dhameja"," H. Cotton","R.LPeurifoy"," Maheswari S.N" };
