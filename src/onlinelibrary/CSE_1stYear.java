...
import java.util.*;
import java.sql.*;
public class CSE_1stYear extends Frame implements ActionListener,ItemListener
{
	...
	String s,s1[]={"Home","Borrow","UG","CSE 1st YEAR"}
	,s2[]={"English - I","Mathematics - I","Engineering Physics - I","Engineering Chemistry - I","Programming and Problem Solving","Engineering Graphics","Environmental Studies","English - II","Mathematics - II","Applied Physics","Engineering Chemistry - II","Object Oriented Programming through C++","Principles Of Electrical Engineering","Engineering Mechanics - I"};
	String 
	s3[]={"E Suresh Kumar","Kanti.B.Datta","M.N. Avadhanulu","P.C.Jain and Monica Jain","PradipDey and ManasGhosh","N.D.Bhatt","Y. Anjaneyulu","E Suresh Kumar","BS. Grewal","M.N. Avadhanulu","Jain and Jain","E. Balagurusamy","Edward  Hughes","K.Vijay Kumar Reddy"},
	s4[]={"Michael McCarthy","Michael Greenburg","S.L. Gupta","Puri & Sharma","R S Bichkar","Basanth Agrawal","S.S.Dara","Michael McCarthy","Michael Greenburg","S.L. Gupta","Puri & Sharma","Bjarne Stroustrup ","V.K.Mehta","Ferdinand L Singer"};
	...
	CSE_1stYear()
	{
		...
		setSize(1500,1500);
		setLayout(null);
		setTitle("CSE 1st YEAR");
		

		l1=new Label("CSE 1st YEAR");
