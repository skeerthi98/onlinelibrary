...
import java.util.*;
import java.sql.*;
public class CSE_3rdYear extends Frame implements ActionListener,ItemListener
{
	...
	Checkbox c1[]=new Checkbox[6],c2[]=new Checkbox[4];
	Checkbox c3,c4;

	Button b[],b1,b2;

	String s="",s1[]={"Home","Borrow","UG","CSE 3rd YEAR"}
	,s2[]={"Automata Languages and Computation","Design and Analysis of Algorithms","Embedded Systems","Database Management Systems","Operating Systems","Human Values and Professional Ethics","Compiler construction","Software Engineering","Web Technologies","Computer Networks"};
	String 
	s3[]={"John E","Horowitz E","Raj Kamal","Abraham Silber","Avi silberchatz","Subramanium","Alfred","Roger S","Robert W","Larry L"},
	s4[]={"John C.Martin","Cormen","David E","Date CJ","Andrew S","Nagarajan","Keith D","Shari L","Subramanyam A","Andrew S"};
	...
	CSE_3rdYear()
	{
		...
		setSize(1500,1500);
		setLayout(null);
		setTitle("CSE 3rd YEAR");
		

		l1=new Label("CSE 3rd YEAR");
