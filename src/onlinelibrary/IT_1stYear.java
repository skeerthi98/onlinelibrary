...
import java.util.*;
import java.sql.*;
public class IT_1stYear extends Frame implements ActionListener,ItemListener
{
	...
	String s="",s1[]={"Home","Borrow","UG","IT 1st Year"}
	,s2[]={"English - I","Mathematics - I","Engineering Physics - I","Engineering Chemistry - I","Programming and Problem Solving","Environmental Studies","Engineering Graphics","English - II","Mathematics - II","Applied Physics","Engineering Chemistry - II","Object Oriented Programming through C++","Principles of Electrical Engineering","Engineering Mechanics-I"};
	String 
	s3[]={"E Suresh Kumar","Kanti.B.Datta","M.N. Avadhanulu","P.C.Jain and Monica Jain","PradipDey and ManasGhosh","N.D.Bhatt","Y. Anjaneyulu","E Suresh Kumar","BS. Grewal","M.N. Avadhanulu","Jain and Jain","E. Balagurusamy","William H.Hayt","K. Vijay Kumar Reddy"},
	s4[]={"Michael McCarthy","Michael Greenburg","S.L. Gupta","Puri & Sharma","R S Bichkar","S.S.Dara","Basanth Agrawal","Michael McCarthy","Michael Greenburg","S.L. Gupta","Puri & Sharma","Bjarne Stroustrup ","Vanlkenberg","Ferdinand L Singer"};
	...
	IT_1stYear()
	{
		...
		setSize(1500,1500);
		setLayout(null);
		setTitle("IT 1st Year");
		

		l1=new Label("IT 1st Year");
	...
	public void itemStateChanged(ItemEvent ie)
	{
		...
		for(int i=0;i<14;i++)
		{
			if(s==s2[i])
			{
				c3=new Checkbox(s3[i],false,cg2);
				c4=new Checkbox(s4[i],false,cg2);
				p4.add(c3);
				p4.add(c4);
				p2.add(p4,"a1");
				this.add(p2);
