...
public class IT_2ndYear extends Frame implements ActionListener,ItemListener
{
	...
	,s2[]={"Discrete Structures","Data Structures","Digital Electronics & Logic Design","Data Communications","Basic Electronics","Managerial
 Economics & Accountancy","Probability and Random Processes","Java Programming","Design and
 Analysis of Algorithms","Theory of Automata","Software Engineering","ComputerOrganization & Microprocessors"};
	String s3[]={"Kenneth H Rosen","Michael T. Goodrich","Stephen Brown","Behrouz A. Forouzan","Robert L. Boylestad"," Mehta P.L","T.Veerarajan","Herbert Schildt","Ellis Horowitz","John E. Hopcroft","Roger S.Pressman","Carl Hamacher"},
	s4[]={"J. K. Sharma","Ellis Horowitz","Jain R.P","William Stallings","Morris Mano"," Maheswari S.N","P.Ramesh Babu","Cay S. Horstmann","Thomas H. Cormen","John C Martin","Carlo Ghezzi","Ramesh S Gaonkar"};
