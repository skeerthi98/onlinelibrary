...
import java.util.*;
import java.sql.*;
public class IT_3rdYear extends Frame implements ActionListener,ItemListener
{
	...
	String s="",s1[]={"Home","Borrow","UG","IT 3rd Year"}
	,s2[]={"Principles of Operating Systems","Database Systems","Compiler Design","Information Security","Object Oriented System Developmentusing UML ","Human Values and Professional Ethics","Computer Networks and Socket Programming","Data Warehousing and Data Mining","Web Programming","Computational Intelligence","Digital Image Processing and Analysis"};
	String 
	s3[]={"Abraham Silberschatz","Abraham Silberschatz","Alfred V Aho","Michael E. Whitman ","Ivor Jacobson","Subramanian R","Andrew S. Tanenbaum","Han J &Kamber M","Robert W.Sebesta","SarojKaushik","Rafael C Gonzalez"},
	s4[]={"A.Tanenbaum","Ramakrishnan","Leland L Bech","Thomas R Peltier","Grady Booch","Nagarajan R.S","W. Richard Stevens","Pang-Ning Tan","John Pollak","Tom M. Mitchell","Vipula Singh"};
	...
	IT_3rdYear()
	{
		...
		setSize(1500,1500);
		setLayout(null);
		setTitle("IT 3rd Year");
		

		l1=new Label("IT 3rd Year");
